...
## 3. Đặc tả use case:
1. Đặc tả và lược đồ sequence use case “Đăng ký”
...
Hình 2: Lược đồ Sequence Use Case “Đăng ký”
2. Đặc tả và lược đồ sequence use case “Đăng nhập”
Use Case: 
Đăng nhập
Short Description 
Cho phép user đăng nhập vào trang chủ
Actor 
User 
Pre-Conditions 
...
Post-Conditions 
User đăng nhập thành công vào trang chủ
Main Flow 
...
Hình 3: Lược đồ Sequence Use Case “Đăng nhập”
3. Đặc tả và lược đồ sequence use case “Đăng nhập”
Use Case: 
Đăng nhập
Short Description 
Cho phép admin đăng nhập vào trang quản lý
Actor 
Admin
Pre-Conditions 
...
Post-Conditions 
Admin đăng nhập thành công vào trang quản lý
Main Flow 
...
Hình 4: Lược đồ Sequence Use Case “Đăng nhập”
...
Hình 5: Lược đồ Sequence Use Case “Quên mật khẩu”
5. Đặc tả use case “Đăng xuất”
Use case 
Đăng xuất 
Short Description 
Cho phép user đăng xuất khỏi trang chủ
Actor
User
Pre-Conditions
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User đăng xuất khỏi trang chủ thành công 
Main Flow 
...
Hình 6: Lược đồ Sequence Use Case “Đăng xuất”
6. Đặc tả use case “Đăng xuất”
Use case 
Đăng xuất 
Short Description 
Cho phép admin đăng xuất khỏi trang quản lý
Actor
Admin
Pre-Conditions
Admin đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
Admin đăng xuất khỏi trang quản lý thành công 
Main Flow 
...
Hình 7: Lược đồ Sequence Use Case “Đăng xuất”
7. Đặc tả use case “Cập nhật thông tin cá nhân”
Use case 
Cập nhật thông tin cá nhân
Short Description 
Cho phép user xem và cập nhật thông tin cá nhân
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
...
Hình 8: Lược đồ Sequence Use Case “Cập nhật thông tin cá nhân”
8. Đặc tả use case “Xem chi tiết sản phẩm”
Use case 
Xem chi tiết sản phẩm 
Short Description 
Cho phép user xem chi tiết sản phẩm
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User xem chi tiết sản phẩm thành công
Main Flow
...
Hình 9: Lược đồ Sequence Use Case “Xem chi tiết sản phẩm”
9. Đặc tả use case “Xem chi tiết sản phẩm”
Use case 
Xem chi tiết sản phẩm 
Short Description 
Cho phép admin xem chi tiết sản phẩm
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
Admin xem chi tiết sản phẩm thành công
Main Flow
...
Hình 10: Lược đồ Sequence Use Case “Xem chi tiết sản phẩm”
10. Đặc tả use case “Tìm kiếm sản phẩm”
Use case 
Tìm kiếm sản phẩm
Short Description 
Cho phép user tìm kiếm sản phẩm
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User tìm kiếm sản phẩm thành công
Main Flow 
...
Hình 11: Lược đồ Sequence Use Case “Tìm kiếm sản phẩm”
11. Đặc tả use case “Lọc sản phẩm”
Use case 
Lọc sản phẩm
Short Description 
Cho phép user lọc sản phẩm
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User lọc sản phẩm thành công
Main Flow 
...
Hình 12: Lược đồ Sequence Use Case “Lọc sản phẩm”
...
User
Pre-Conditions 
User đã thực hiện use case “Đặt hàng” thành công và đơn hàng muốn hủy trong trạng thái “Đang xử lý”
Post-Conditions 
...
Hình 13: Lược đồ Sequence Use Case “Hủy đơn hàng”
13. Đặc tả use case “Đánh giá sản phẩm đã mua”
Use case 
Đánh giá sản phẩm đã mua
Short Description 
Cho phép user đánh giá sản phẩm đã mua
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đặt hàng” thành công và sản phẩm muốn đánh giá trong trạng thái “Đã giao thành công”
Post-Conditions 
User đánh giá sản phẩm đã mua thành công
Main Flow 
...
Hình 14: Lược đồ Sequence Use Case “Đánh giá sản phẩm đã mua”
14. Đặc tả use case “Yêu thích sản phẩm”
Use case 
Yêu thích sản phẩm
Short Description 
Cho phép user yêu thích sản phẩm
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User yêu thích sản phẩm thành công
Main Flow 
...
Hình 15: Lược đồ Sequence Use Case “Yêu thích sản phẩm”
15. Đặc tả use case “Thêm vào giỏ hàng”
Use case 
Thêm vào giỏ hàng
Short Description 
Cho phép user thêm sản phẩm vào giỏ hàng
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
User thêm sản phẩm vào giỏ hàng thành công
Main Flow 
...
Hình 16: Lược đồ Sequence Use Case “Thêm vào giỏ hàng”
16. Đặc tả use case “Đặt hàng”
Use case 
Đặt hàng
Short Description 
Cho phép user đặt hàng
Actor 
User
Pre-Conditions 
User đã thực hiện use case “Đăng nhập” thành công
...
Hình 17: Lược đồ Sequence Use Case “Đặt hàng”
17. Đặc tả use case “Xác nhận đặt hàng”
Use case 
Thêm sản phẩm
Short Description 
Cho phép người dùng xác nhận đặt hàng với các sản phẩm đã chọn trong giỏ hàng.
...
Hình 18: Lược đồ Sequence Use Case “Xác nhận đặt hàng”
18. Đặc tả use case “Thêm sản phẩm”
Use case 
Thêm sản phẩm
Short Description 
Cho phép admin thêm sản phẩm
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
...
Hình 19: Lược đồ Sequence Use Case “Thêm sản phẩm”
19. Đặc tả use case “Xóa sản phẩm”
Use case 
Xóa sản phẩm
Short Description 
Cho phép admin xóa sản phẩm
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
...
Hình 20: Lược đồ Sequence Use Case “Xóa sản phẩm”
20. Đặc tả use case “Chỉnh sửa sản phẩm”
Use case 
Chỉnh sửa sản phẩm
Short Description 
Cho phép admin chỉnh sửa sản phẩm
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
Admin chỉnh sửa sản phẩm thành công
Main Flow 
...
Hình 21: Lược đồ Sequence Use Case “Chỉnh sửa sản phẩm”
21. Đặc tả use case “Quản lý doanh số sản phẩm”
Use case 
Quản lý doanh số sản phẩm
Short Description 
Cho phép admin chỉnh sửa doanh số sản phẩm
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
Admin chỉnh sửa doanh số sản phẩm thành công
Main Flow 
...
Hình 22: Lược đồ Sequence Use Case “Quản lý doanh số sản phẩm”
22. Đặc tả use case “Chỉnh sửa trạng thái đơn hàng”
Use case 
Chỉnh sửa trạng thái đơn hàng
Short Description 
Cho phép admin chỉnh sửa trạng thái đơn hàng
Actor 
Admin
Pre-Conditions 
Admin đã thực hiện use case “Đăng nhập” thành công
Post-Conditions 
Admin chỉnh sửa trạng thái đơn hàng thành công
Main Flow 
...
Hình 23: Lược đồ Sequence Use Case “Chỉnh sửa trạng thái đơn hàng”
